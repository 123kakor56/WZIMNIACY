...
public partial class UiManager : Node
{
    ...
    {
        if (property["name"].AsStringName() == PropertyName.a)
        {
            PropertyUsageFlags usage = property["usage"].As<PropertyUsageFlags>() | PropertyUsageFlags.Secret;
			GD.Print("HMMMMMMMMMMMMMM");
			GD.Print(usage);
